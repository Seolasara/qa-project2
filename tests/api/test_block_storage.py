...
def test_BS002_list_emptylook_up(auth_token):
...
def test_BS004_create_fail_missing_parameters(auth_token):
...
def test_BS005_create_fail_invalid_data_type(auth_token):
...
def test_BS007_get_fail_non_existent_id(auth_token):
